...
//------------------------------------------------------------
bool validateMarsKeyValue(const eckit::Value& language,
...
int main()
{
    // try {
        // Load language.yaml
        eckit::Value languages_ = eckit::YAMLParser::decodeFile(eckit::PathName("/ec/res4/hpcperm/mavm/ba/metkit-bundle/language.yaml"));
        ...
        /// eckit::LocalConfiguration language = languages_; //.as<eckit::LocalConfiguration>().getSubConfiguration("_fields");
        /// std::cout << language << ": " << language.has("_field") << language.has("class") << std::endl;
