...
struct DictGetOrThrow<eckit::LocalConfiguration, CTYPE> {                              \
                                                                                       \
    static CTYPE get_or_throw(const eckit::LocalConfiguration& cfg,                    \
        ...
        try {                                                                          \
            ...
            if ( !cfg.has(k) ) {                                                       \
                throw exceptions::Mars2GribDictException(                              \
                        "Missing key `"s + k + "` in dictionary type `"s +             \
            ...
            if ( hacks::ISFUNC(cfg, k) ) {                                             \
                ...
                throw exceptions::Mars2GribDictException(                              \
                    "Key `"s + k + "` is not of expected type `"s +                    \
                        std::string(type_name<CTYPE>()) +                              \
                        "` for dictionary type `"s +                                   \
                        std::string(type_name<eckit::LocalConfiguration>()) + "`",     \
                    Here()                                                             \
                );                                                                     \
            }                                                                          \
...
// -----------------------------------------------------------------------------
template<> constexpr std::string_view type_name<eckit::LocalConfiguration>()  {
...
struct DictHas<eckit::LocalConfiguration> {
    ...
    static bool has(const eckit::LocalConfiguration& cfg,
                    std::string_view key) noexcept(false)
    {
        const std::string k{ key };
...
M2G_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(eckit::LocalConfiguration,
                                         isSubConfiguration,
                                         getSubConfiguration)
M2G_DEFINE_LOCALCONFIG_DICT_GET_OPT(eckit::LocalConfiguration,
                                    isSubConfiguration,
                                    getSubConfiguration)
...
// std::vector<int>
M2G_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::vector<int>,
                                         isIntegralList,
                                         getIntVector)
M2G_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::vector<int>,
                                    isIntegralList,
                                    getIntVector)
...
// std::vector<long>
M2G_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::vector<long>,
                                         isIntegralList,
                                         getLongVector)
M2G_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::vector<long>,
                                    isIntegralList,
                                    getLongVector)
...
// std::vector<float>
M2G_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::vector<float>,
                                         isFloatingPointList,
                                         getFloatVector)
M2G_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::vector<float>,
                                    isFloatingPointList,
                                    getFloatVector)
...
// std::vector<double>
M2G_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::vector<double>,
                                         isFloatingPointList,
                                         getDoubleVector)
M2G_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::vector<double>,
                                    isFloatingPointList,
                                    getDoubleVector)
...
M2G_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::vector<std::string>,
                                         isStringList,
                                         getStringVector)
M2G_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::vector<std::string>,
                                    isStringList,
                                    getStringVector)
...
M2G_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::vector<eckit::LocalConfiguration>,
                                         isSubConfigurationList,
                                         getSubConfigurations)
M2G_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::vector<eckit::LocalConfiguration>,
                                    isSubConfigurationList,
                                    getSubConfigurations)
