...
public:
                                        ...
                                        const OptDict_t&  opt ) const
    {
        ...
        try {
            ...
            LOG_DEBUG_LIB(LibMetkit) << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl;
            ...
            for ( const auto& stage : settersTable_ ) {
                ...
                LOG_DEBUG_LIB(LibMetkit) << "STAGE :: ****************************************************************" << std::endl;
                for ( const auto& section : stage ) {
                    LOG_DEBUG_LIB(LibMetkit) << std::endl << std::endl << std::endl;
                    LOG_DEBUG_LIB(LibMetkit) << "  SECTION :: ****************************************************************" << std::endl;
                    for ( const auto& conceptSetter : section ) {
                        LOG_DEBUG_LIB(LibMetkit) << std::endl << std::endl << std::endl;
                        LOG_DEBUG_LIB(LibMetkit) << "      CONCEPT :: ****************************************************************" << std::endl;
