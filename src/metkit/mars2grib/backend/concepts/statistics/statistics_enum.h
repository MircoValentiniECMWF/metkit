...
using StatisticsList = ValueList<
    ...
    StatisticsType::DifferenceFromStart,
    StatisticsType::RootMeanSquare,
    StatisticsType::StandardDeviation,
    StatisticsType::Covariance,
    StatisticsType::DifferenceFromEnd,
    StatisticsType::Ratio,
    StatisticsType::StandardizedAnomaly,
    StatisticsType::Summation,
    StatisticsType::ReturnPeriod,
    StatisticsType::Median,
    StatisticsType::Severity,
    StatisticsType::Mode,
    StatisticsType::IndexProcessing,
