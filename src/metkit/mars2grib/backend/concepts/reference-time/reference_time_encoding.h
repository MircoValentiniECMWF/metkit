...
constexpr bool referenceTimeApplicable( std::size_t Stage, std::size_t Section, ReferenceTimeType Variant)
{
    ...
    bool condition2 = (Variant == ReferenceTimeType::Reforecast) &&
                      (Stage   == StagePreset) &&
    ...
    if constexpr ( referenceTimeApplicable(Stage, Section, Variant) ) {
        ...
        try {
            ...
            if constexpr ( Section == SecIdentificationSection ) {
                ...
                set_or_throw<long>( out,
                    "significanceOfReferenceTime",
                    static_cast<long>(significanceOfReferenceTime)
                );
            ...
            if constexpr ( (Section == SecProductDefinitionSection) &&
                           (Variant == ReferenceTimeType::Reforecast) ) {
