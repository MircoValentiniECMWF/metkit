...
{
  if constexpr (
        Variant == LevelType::HeightAboveGroundAt10M ||
        Variant == LevelType::HeightAboveGroundAt2M ||
        Variant == LevelType::HeightAboveGround ||
        Variant == LevelType::HeightAboveSeaAt10M ||
        Variant == LevelType::HeightAboveSeaAt2M ||
        Variant == LevelType::HeightAboveSea ||
        Variant == LevelType::Hybrid ||
        Variant == LevelType::IsobaricInHpa ||
        Variant == LevelType::IsobaricInPa ||
        Variant == LevelType::Isothermal ||
        Variant == LevelType::PotentialVorticity ||
        Variant == LevelType::SeaIceLayer ||
        Variant == LevelType::SnowLayer ||
        Variant == LevelType::SoilLayer ||
        Variant == LevelType::Theta
    ) {
        return true;
    } else {
        return false;
        ...
        try {
            ...
            std::throw_with_nested(
                Mars2GribConceptException(
                    ...
                    std::string( levelTypeName<Variant>() ),
                    std::to_string(Stage),
