...
void setTime(const eckit::LocalConfiguration& mars, eckit::LocalConfiguration& sections) {
    ...
    if (matchAny(param, range(1, 3), 10, range(15, 18), range(21, 23), range(26, 43), 53, 54, 59, 60, 66, 67,
                 ...
                 range(243, 248), 3020, 3031, 3067, range(3073, 3075), 129172, range(140098, 140105),
                 range(140112, 140129), range(140131, 140134), range(140207, 140209), 140211, 140212,
                 ...
                 228132, 228141, 228164, range(228217, 228221), range(228231, 228237), 235080, 237080, 238080, 239080,
                 260004, 260005, 260015, 260038, 260048, 260109, 260121, 260123, 260132, 260199, 260242, 260255, 260260,
                 260289, 260290, 260292, 260293, 260360, 260509, 260688, 261001, 261002, range(261014, 261016), 261018,
                 262000, 262024, 262100, 262104, 262118, 262124, 262139, 262140, 262144)) {
